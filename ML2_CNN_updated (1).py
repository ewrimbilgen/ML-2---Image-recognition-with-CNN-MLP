...
# # Alternative part -1 : Using different optimization approach- model 2
...
#gave same parameters

Epoch=25
batch= 15
size= 256 #Gave smaller size
nb_classes=30 #my classes
IN_SHAPE=(size,size,3) 
...
# Total params: 41,029,286
# Trainable params: 40,804,854
# Non-trainable params: 224,432

# In[44]:


hist = model2.fit(train_generator, epochs=Epoch, validation_data=valid_generator)
